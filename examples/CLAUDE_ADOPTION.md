...
|----------|----------|---------|
| 1 | [ROADMAP.md](docs/ROADMAP.md) | Current analytics work |
| 2 | [SESSION_LOG.md](docs/SESSION_LOG.md) | Recent session history |
| 3 | [OVERVIEW.md](docs/OVERVIEW.md) | Model inventory and lineage |
| 4 | [ADR.md](docs/ADR.md) | Data modeling decisions |
| 5 | [VISION.md](docs/VISION.md) | Data platform direction |
