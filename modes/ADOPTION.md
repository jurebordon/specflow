...
3. Create `docs/features/<name>/SPEC.md`
4. Create `docs/features/<name>/ROADMAP.md`
5. Create `docs/features/<name>/SESSION_LOG.md`
6. Link to ticket/MR if provided
...
### Files Changed
- docs/features/customer-dimension/SPEC.md (new)
- docs/features/customer-dimension/ROADMAP.md (new)
- docs/features/customer-dimension/SESSION_LOG.md (new)
...
- docs/features/customer-dimension/SPEC.md (requirements)
- docs/features/customer-dimension/ROADMAP.md (current tasks)
- docs/features/customer-dimension/SESSION_LOG.md (recent work)

Plan the next task from the feature ROADMAP.
```

**end-session.md** (feature mode):
```markdown
Update feature documentation:
- docs/features/customer-dimension/ROADMAP.md (mark task done)
- docs/features/customer-dimension/SESSION_LOG.md (add entry)

If feature is complete:
- Update project docs/ADR.md if decisions were made
- Archive or mark feature as done
```

### When Features Complete

When a feature is done:
1. Update feature ROADMAP.md - all tasks in "Done"
2. Add final SESSION_LOG entry
3. Optionally move feature folder to `docs/features/_completed/`
4. Update project-level ADR.md if significant decisions were made
5. Update project OVERVIEW.md if architecture changed
